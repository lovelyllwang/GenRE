...
def get_args():
    ...
    parser.add_argument("--model_dir", type=str, default="/data/wanglulu/plm/glm-large/", help="model dir")
    parser.add_argument("--train_data_dir", type=str, default="/data/wanglulu/RE/DATA/edu/train_QA.json", help="train data dir")
    parser.add_argument("--valid_data_dir", type=str, default="/data/wanglulu/RE/DATA/edu/test_QA.json", help="dev data dir")
    parser.add_argument("--test_data_dir", type=str, default="/data/wanglulu/RE/DATA/edu/test_QA.json", help="test data dir")
    parser.add_argument("--out_dir", type=str, default="./checkpoint/", help="checkpoint save dir")
    parser.add_argument("--learning_rate", type=float, default=2e-5, help="Learning rate")
    parser.add_argument("--source_max_token_len", type=int, default=448, help="source max token length")
    parser.add_argument("--target_max_token_len", type=int, default=64, help="target max token length")
